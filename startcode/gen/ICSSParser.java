...
public class ICSSParser extends Parser {
	...
	public static final int
		RULE_stylesheet = 0, RULE_content = 1, RULE_variable_declaration = 2, 
		RULE_css_rule = 3, RULE_body = 4, RULE_declaration = 5, RULE_property = 6, 
		RULE_expression = 7, RULE_term = 8, RULE_factor = 9, RULE_add_op = 10, 
		RULE_mult_op = 11, RULE_if_statement = 12, RULE_condition = 13;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "content", "variable_declaration", "css_rule", "body", 
			"declaration", "property", "expression", "term", "factor", "add_op", 
			"mult_op", "if_statement", "condition"
		};
	}
	...
	public static class ContentContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterContent(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitContent(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitContent(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Variable_declarationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterVariable_declaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitVariable_declaration(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitVariable_declaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Css_ruleContext css_rule() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_css_rule);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class Add_opContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitAdd_op(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final Add_opContext add_op() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_add_op);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public static class Mult_opContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitMult_op(this);
			else return visitor.visitChildren(this);
		}
	}
